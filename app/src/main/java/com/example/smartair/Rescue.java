...
public class Rescue extends PEF {
    private String prePostStatus;
    private double rating;

    public Rescue() {}

    public Rescue(LocalDateTime date, String id, double count, String prePostStatus, double rating) throws IllegalArgumentException {
        super(date, id, count);
    ...
    public Rescue(String date, String id, double count, String prePostStatus, double rating) throws DateTimeParseException, IllegalArgumentException {
        super(date, id, count);
        this.prePostStatus = prePostStatus;
        if (rating < 0 || rating >10) {
            throw new IllegalArgumentException("Rating must be between 0 and 10");
